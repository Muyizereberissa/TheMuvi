...
//                 <TextInput label="Email" mode="offline"  placeholder='' left={<TextInput.Icon color={'violet'} size={15} icon={"email-outline"} style={{backgroundColor:'#FF9BD2'}}  />} style={{ marginTop: 10, width: 300, alignSelf: 'center', backgroundColor: '#EEF5FF', }} />
...
//             </View>
//             <View style={{ marginTop: 15, display: 'flex', flexDirection: 'row',alignItems:'start', justifyContent:'start'}}>
...
//       <View style={{marginTop: 25, display: 'flex', flexDirection: 'row', gap:100,alignItems: 'center',justifyContent: 'center',}}>
//         <Text style={{fontSize: 15, fontWeight: '300', marginLeft: 40}}>Creat account</Text>
...
//         <TouchableOpacity><Icon name="facebook" size={30} color="blue" style={{ borderWidth: 1, borderColor: 'white', borderRadius: 80, padding: 10, backgroundColor: '#EEF5FF', marginLeft: 20 }} /></TouchableOpacity>
//         <TouchableOpacity><Icon name="google" size={30} color="red" style={{ borderWidth: 1, borderColor: 'white', borderRadius: 80, padding: 10, backgroundColor: '#EEF5FF', marginLeft: 20 }} /></TouchableOpacity>
//         <TouchableOpacity><Icon name="apple" size={30} color="black" style={{ borderWidth: 1, borderColor: 'white', borderRadius: 80, padding: 10, backgroundColor: '#EEF5FF', marginLeft: 20 }} /></TouchableOpacity>
//       </View>
